...
- 캐릭터 말투가 상담사/생활정보/다정한 애인 템플릿으로 흐르던 문제를 줄이기 위해 프롬프트를 대폭 단순화했습니다.
- Care는 “다정 우쭈쭈”가 아니라 현실 고민/일상/멘탈 주제용 모드로 다시 정리했습니다.
- 캐릭터 보이스 우선순위를 강화하고, 이전 콩고물 토오크 답변의 어색한 말투를 그대로 따라가지 않도록 조정했습니다.
- 메시지 대화라는 경계를 유지하되, 캐릭터를 더 성숙하고 친절하게 보정하지 않도록 수정했습니다.
